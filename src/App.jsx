...
const RIM_DATABASE = {
  ...
  "BBS": [{ name: "FS", img: "https://i.imgur.com/wO3KViq.jpeg" }, { name: "LM-G", img: "https://i.imgur.com/VEzmk4g.jpeg" }, { name: "RI_D", img: "https://i.imgur.com/ARlqCLR.jpeg" }],
  "CCW": [{ name: "CCW", img: "https://i.imgur.com/6ZzpFEI.jpeg" }],
  "Centerline": [{ name: "Rev7", img: "https://i.imgur.com/fjWsqGv.jpeg" }],
  ...
  "Work": [
    ...
    { name: "Meister_S1", img: "id=1ufqzpgy0kCzFbnniY_qWJi2oDTSNr_6T" }, { name: "VS_XX", img: "id=1vzsA-htawcdnfG9xve000uUTA4Al4lOW" }, { name: "VS-KF", img: "https://i.imgur.com/RT2ZhPZ.jpeg" },
  ...
  return (
    <div className={`min-h-screen bg-[#0B0F19] text-white font-sans px-6 md:px-12 selection:bg-cyan-500/30 overflow-x-hidden pb-24 relative ${patronName ? 'pt-10' : ''}`}>
      ...
      <div className="max-w-[1900px] mx-auto pt-10 pb-12 h-full flex flex-col">
        <header className="flex flex-col items-center justify-center space-y-3 pb-4">
